<template>
  <NSpace vertical class="p-4">
    ...
    <NCollapse default-expanded-names="1" accordion>
      <NCollapseItem title="NCollapseItem1" name="1"> NCollapseItem1 </NCollapseItem>
      <NCollapseItem title="NCollapseItem2" name="2"> NCollapseItem2 </NCollapseItem>
    </NCollapse>
    ...
    <NModal v-model:show="showModal" preset="card" title="NModal" />
    Drawer
    ...
    <NDescriptions label-placement="top" title="NDescription">
      ...
      <NDescriptionsItem label="NDescriptionsItem2"> NDescriptionsItem2 </NDescriptionsItem>
      <NDescriptionsItem label="NDescriptionsItem3"> NDescriptionsItem3 </NDescriptionsItem>
    </NDescriptions>
    NCollapseTransition
    ...
    <NImageGroup>
      <NImage width="100" src="https://07akioni.oss-cn-beijing.aliyuncs.com/07akioni.jpeg" />
      <NImage width="100" src="https://gw.alipayobjects.com/zos/antfincdn/aPkFc8Sj7n/method-draw-image.svg" />
    </NImageGroup>
    <!-- BUG: break & tree data -->
    <!-- transfer mismatch -->
